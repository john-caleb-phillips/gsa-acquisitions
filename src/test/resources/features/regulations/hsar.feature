@all @regulations @hsar-regulation
Feature: Regulations

  @validate-regulation-hsar-page-layout
  Scenario: HSAR Page Layout
    ...
    And I see the regulation content is the following:
      ...
      Effective Date: DATE{D MMM YYYY}
  ...
  @validate-regulation-hsar-table
  Scenario: HSAR Table Contents
    Given I am on the HSAR regulation page
  ...
  @validate-regulation-hsar-detail-pages
  Scenario: HSAR Detail Pages
    Given I am on the HSAR regulation page
    When I save the info from the table regulation detail pages
    Then the regulation name on each table regulation detail page is "HSAR"
