@all @regulations @dear-regulation
Feature: Regulations

  @validate-regulation-dear-page-layout
  Scenario: DEAR - Page Layout
  ...
  @validate-regulation-dear-table
  Scenario: DEAR - Table Contents
    Given I am on the DEAR regulation page
  ...
  @validate-regulation-dear-detail-pages
  Scenario: DEAR - Detail Pages
    Given I am on the DEAR regulation page
    When I save the info from the table regulation detail pages
    Then the regulation name on each table regulation detail page is "DEAR"
