@all @regulations @fehbar-regulation
Feature: Regulations

  @validate-regulation-fehbar-page-layout
  Scenario: FEHBAR - Page Layout
  ...
  @validate-regulation-fehbar-table
  Scenario: FEHBAR - Table Contents
    Given I am on the FEHBAR regulation page
  ...
  @validate-regulation-fehbar-detail-pages
  Scenario: FEHBAR - Detail Pages
    Given I am on the FEHBAR regulation page
    When I save the info from the table regulation detail pages
    Then the regulation name on each table regulation detail page is "FEHBAR"
