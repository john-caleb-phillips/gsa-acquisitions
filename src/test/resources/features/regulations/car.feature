@all @regulations @car-regulation
Feature: Regulations

  @validate-regulation-car-page-layout
  Scenario: CAR Page Layout
  ...
  @validate-regulation-car-table
  Scenario: CAR Table Contents
    Given I am on the CAR regulation page
  ...
  @validate-regulation-car-detail-pages
  Scenario: CAR Detail Pages
    Given I am on the CAR regulation page
    When I save the info from the table regulation detail pages
    Then the regulation name on each table regulation detail page is "CAR"
