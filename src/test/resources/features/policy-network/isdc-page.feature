...
Feature: Policy Network - Interagency Suspension and Debarment Committee (ISDC)
  ...
  Scenario Outline: Main Page Footer Links
    ...
    Examples:
      | Link Text                         | Destination Url                                        |
      | Debarring Officials               | https://www.acquisition.gov/isdc-debarring-officials   |
      | Debarment Regulations             | https://www.acquisition.gov/isdc-debarment-regulations |
  ...
  Scenario: Debarring Officials Page Layout
    Given I am on the ISDC page
    When I click on ISDC footer link "Debarring Officials"
    Then I see the ISDC header is the following:
      """
    ...
    And I see the following table of ISDC debarring officials:
      ...
      | USDA – Economic Research Service (ERS)                                                           | Marca Weinberg                                         | Kim L. Radcliff           | (301)504-1141 kim.radcliff@usda.gov               |
      ...
      | USDA – Rural Business and Cooperative Service (RBCS)                                             | Mark Brodziski                                         | Janet Stouder             | (202) 720-9728 janet.stouder@usda.gov             |
      | USDA – Rural Housing Service (RHS)                                                               | Chad Parker                                            | Janet Stouder             | (202) 720-9728 janet.stouder@usda.gov             |
      | USDA – Rural Utilities Service (RUS)                                                             | Chap Rupe                                              | Janet Stouder             | (202) 720-9728 janet.stouder@usda.gov             |
      ...
      | U.S. Department of Education                                                                     | Jim Stader, debarments Alfreida Pettiford, suspensions | Philip Rosenfelt          | Phil.Rosenfelt@ed.gov                             |
      ...
      | DHS – Customs and Border Patrol (CBP)                                                            | Jerry Malmo                                            | Virginia McPherson        | (202) 579-5845 virginia.h.mcpherson@cbp.dhs.gov   |
      ...
      | DOT FAA (Procurement)                                                                            | Patricia A. McNall                                     | Maureen Cummings-Spickler | (202) 267-3181 Maureen.cummings-sprickler@faa.gov |
      ...
      | DOT Federal Motor Carrier Safety Administration (FMCSA)                                          | James Mullen                                           | Jean Wulff                | (202) 366-0424 jean.wulff@dot.gov                 |
      ...
      | DOT John A. Volpe National Transportation Systems Center (VOLPE)                                 | Gregory Cate                                           | Felecia McBride           | (617) 494-2734 Felecia.McBride@dot.gov            |
      | DOT - Saint Lawrence Seaway (SLSDC)                                                              | Nancy Scott                                            | Carrie Lavigne            | (315) 764-3231 Carrie.lavigne@dot.gov             |
      | U.S. Department of the Treasury                                                                  | Michelle D. Sharpe, Actg.                              | Sean McClure              | (202) 622-0903 Sean.mcclure@treasury.gov          |
      | U.S Agency for International Development (USAID)                                                 | Azza El-Abd                                            | Katie Stohs               | (571) 243 5887 kstohs@usaid.gov                   |
  ...
  Scenario: Debarment Regulations Page Layout
    Given I am on the ISDC page
    When I click on ISDC footer link "Debarment Regulations"
    Then I see the ISDC header is the following:
      """
      Interagency Suspension and Debarment Committee (ISDC)
      """
  ...
  Scenario Outline: Debarment Regulations Page Content Links
    ...
    Examples:
      ...
      | http://www.acquisition.gov/content/subpart-94-debarment-suspension-and-ineligibility | https://www.acquisition.gov/far/subpart-9.4                                          |
  ...
  Scenario: Reporting Page Layout
    Given I am on the ISDC page
    When I click on ISDC footer link "Reporting"
    Then I see the ISDC header is the following:
      """
      Interagency Suspension and Debarment Committee (ISDC)
      """
  ...
  Scenario Outline: Compelling Reasons Determinations Page Content Links
    ...
    Examples:
      ...
      | 48 C.F.R. § 9.405                            | https://www.acquisition.gov/far/subpart-4.11#i1122064                                                               |
      | 10 U.S.C. § 2393                             | https://uscode.house.gov/view.xhtml?req=granuleid:USC-prelim-title10-section2393&num=0&edition=prelim               |
      | 48 C.F.R. § 9.405                            | https://www.acquisition.gov/far/subpart-4.11#i1122064                                                               |
