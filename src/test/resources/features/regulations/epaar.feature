@all @regulations @epaar-regulation
Feature: Regulations

  @validate-regulation-epaar-page-layout
  Scenario: EPAAR Page Layout
    ...
    And I see the regulation content is the following:
      ...
      Current to: Effective DATE{D MMM YYYY}
  ...
  @validate-regulation-epaar-table
  Scenario: EPAAR Table Contents
    Given I am on the EPAAR regulation page
  ...
  @validate-regulation-epaar-detail-pages
  Scenario: EPAAR Detail Pages
    Given I am on the EPAAR regulation page
    When I save the info from the table regulation detail pages
    Then the regulation name on each table regulation detail page is "EPAAR"
