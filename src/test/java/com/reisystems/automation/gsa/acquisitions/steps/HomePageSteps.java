...
public class HomePageSteps {
    ...
    public HomePageSteps(HomePage homePage, NewsPage newsPage) {
    ...
    public void clickOvalButton(String buttonText) {
        ...
        BlazeDriver.getElement(homePage.ovalButtonLocator(buttonText)).click(ClickResult.REFRESH_PAGE);
    }
    ...
    public void clickSquareButton(String buttonText) {
        ...
        BlazeDriver.getElement(homePage.squareButtonLocator(buttonText)).click(ClickResult.REFRESH_PAGE);
    }
    ...
    public void test(String valueKey) {
        ...
        for (BlazeWebElement homePageNewsItem : BlazeDriver.getElements(By.xpath("//div[contains(@class, 'front-news')]"))) {
        ...
        BlazeDriver.assertion().assertThat(homePageNewsItems)
                ...
                .containsExactlyElementsOf(gson.fromJson(BlazeDriver.properties().getProperty(valueKey), type));
    ...
    public void asd(String valueKey) {
        ...
        for (BlazeWebElement homePageUpdateItem : BlazeDriver.getElements(By.xpath("//h1[.='FAC Updates']/../div"))) {
        ...
        BlazeDriver.assertion().assertThat(homePageUpdateItems)
                .usingElementComparator(new Comparator<>() {
                    @Override
    ...
    public void verifyOvalButtons(List<String> expectedOvalButtons) {
        BlazeDriver.assertion().assertThat(homePage.getOvalButtons())
    ...
    public void verifySquareButtons(List<String> expectedSquareButtons) {
        BlazeDriver.assertion().assertThat(homePage.getSquareButtons())
                .as("Verifying homepage oval buttons")
    ...
    public void verifySquareButtonPictures(Map<String, String> expectedPictures) throws IOException {
        for (Map.Entry<String, String> entry : expectedPictures.entrySet()) {
            BufferedImage fromFile = BlazeDriver.images().getFromFile(entry.getValue());
            BufferedImage fromPage = BlazeDriver.images().getFromImgTag(By.xpath(
                    String.format(
            ...
            BlazeDriver.assertion().assertThat(BlazeDriver.images().compareTwoImages(fromFile, fromPage, 0))
