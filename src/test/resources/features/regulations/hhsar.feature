@all @regulations @hhsar-regulation
Feature: Regulations

  @validate-regulation-hhsar-page-layout
  Scenario: HHSAR Page Layout
  ...
  @validate-regulation-hhsar-table
  Scenario: HHSAR Table Contents
    Given I am on the HHSAR regulation page
  ...
  @validate-regulation-hhsar-detail-pages
  Scenario: HHSAR Detail Pages
    Given I am on the HHSAR regulation page
    When I save the info from the table regulation detail pages
    Then the regulation name on each table regulation detail page is "HHSAR"
